...
<head>
    ...
    <!-- Chart Container -->
    <div class="mt-7 max-w-4xl mx-auto bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg">
    ...
    <div class="mt-10 flex flex-wrap justify-center gap-4 px-6">
        ...
        <a href="/status" class="bg-cyan-500 hover:bg-cyan-600 text-white font-semibold px-5 py-2 rounded-md shadow">📈 Status</a>
